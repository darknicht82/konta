<?php
require_once 'base/list_decoration.php';
require_once 'base/list_filter_checkbox.php';
require_once 'base/list_filter_date.php';
require_once 'base/list_filter_select.php';
 ...
 */
abstract class list_controller extends controller
{
    ...
    {
        $filter = new list_filter_checkbox($col_name, $label, $operation, $match_value);
    ...
    {
        $filter = new list_filter_date($col_name, $label, $operation);
        $this->add_filter($tab_name, $filter);
    }
    ...
    {
        $filter = new list_filter_select($col_name, $label, $values);
        $this->add_filter($tab_name, $filter);
    }
    ...
    protected function load_data($tab_name)
    {
        ...
        if ($tab_name === $this->active_tab) {
            ...
            $this->tabs[$tab_name]['cursor'] = $this->db->select_limit($sql2, JG_ITEM_LIMIT, $this->offset);
        }
    ...
    protected function private_core()
    {
        ...
        $this->decoration = new list_decoration();
