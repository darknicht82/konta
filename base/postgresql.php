 ...
 */
class postgresql extends db_engine
{
    ...
    public function connect()
    {
        ...
        if (self::$link) {
            ...
            self::$link = pg_connect('host=' . JG_DB_HOST . ' dbname=' . JG_DB_NAME .
                ' port=' . JG_DB_PORT . ' user=' . JG_DB_USER . ' password=' . JG_DB_PASS);
            if (self::$link) {
                $connected = TRUE;
    ...
    public function get_columns($table_name)
    {
        ...
        $sql = "SELECT column_name as name, data_type as type, character_maximum_length, column_default as default, is_nullable"
            . " FROM information_schema.columns WHERE table_catalog = '" . JG_DB_NAME
