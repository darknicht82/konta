...
abstract class model
{
     ...
     * Implementa la clase mysql o postgresql.
     * @var db2
     */
    protected $db;
    ...
    public function __construct($table_name)
    {
        ...
        if (!isset(self::$checked_tables)) {
            ...
            self::$checked_tables = $this->cache->get_array('checked_tables');
        ...
        if ($table_name != '' && !in_array($table_name, self::$checked_tables) && $this->check_table($table_name)) {
            ...
            $this->cache->set('checked_tables', self::$checked_tables, 5400);
        }
    }
    ...
    {
        self::$checked_tables = [];
        $this->cache->delete('checked_tables');
    }
