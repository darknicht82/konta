...
/**
 * Controlador de Clientes -> Retenciones.
 * @author Jonathan Guamba <jonathang_28@hotmail.es>
 */
class informes_retenciones_clientes extends controller
{
    public $idempresa;
    public $fec_desde;
    public $fec_hasta;
    ...
    {
        parent::__construct(__CLASS__, 'Retenciones', 'Informes', 'Clientes', true, false, 'bi bi-clipboard2-minus');
    }
