 ...
 */
class admin_rol extends controller
{
    ...
    {
        parent::__construct(__CLASS__, 'Editar rol', 'Administrador', FALSE, FALSE);
    }
    ...
    protected function private_core()
    {
        ...
        if (filter_input_req('codrol')) {
            $rol = new rol();
            $this->rol = $rol->get(filter_input_req('codrol'));
        }
    ...
    private function modify()
    {
        ...
        if ($this->rol->save()) {
            ...
            foreach ($this->all_pages() as $p) {
                /**
                 * Creamos un objeto rol_access con los datos del rol y la página.
                 ...
                 */
                $a = new rol_access(array('codrol' => $this->rol->codrol, 'page' => $p->name, 'allow_delete' => FALSE));
                if ($allow_delete) {
            ...
            foreach ($this->all_users() as $u) {
                /**
                 * Creamos un objeto rol_user con los datos del rol y el usuario.
                 * Si tiene acceso guardamos, sino eliminamos. Así no tenemos que comprobar uno a uno
                 * si ya estaba en la base de datos. Eso lo hace el modelo.
                 */
                $a = new rol_user(array('codrol' => $this->rol->codrol, 'nick' => $u->nick));
