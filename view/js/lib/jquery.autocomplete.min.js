...
(function(d) {
    ...
    k.utils = n;
    d.Autocomplete = k;
    k.formatResult = function(a, b) {
        var c = "(" + n.escapeRegExChars(b) + ")";
        return a.value.replace(new RegExp(c, "gi"), "<strong>$1</strong>")
    };
    k.prototype = {
        killerFn: null,
        initialize: function() {
            ...
            a.noSuggestionsContainer = d('<div class="autocomplete-no-suggestion"></div>').html(this.options.noSuggestionNotice).get(0);
            a.suggestionsContainer = k.utils.createNode(e.containerClass);
        ...
        fixPosition: function() {
            var a = d(this.suggestionsContainer),
                b = a.parent().get(0);
            if (b === document.body || this.options.forceFixPosition) {
                var c = this.options.orientation,
                    e = a.outerHeight(),
                ...
                if ("auto" == c) var c = d(window).height(),
                    p = d(window).scrollTop(),
                    l = -p + h.top - e,
                    c = Math.max(l, p + c - (h.top + f + e)) === l ? "top" : "bottom";
                g.top = "top" === c ? g.top + -e : g.top + f;
                b !== document.body && (b = a.css("opacity"), this.visible || a.css("opacity", 0).show(), e = a.offsetParent().offset(), g.top -= e.top, g.left -= e.left, this.visible || a.css("opacity", b).hide());
                "auto" === this.options.width && (g.width = this.el.outerWidth() - 2 + "px");
                a.css(g)
            }
        },
        ...
        findSuggestionIndex: function(a) {
            ...
            d.each(this.suggestions, function(a, d) {
                if (d.value.toLowerCase() === c) return b = a, !1
            });
            return b
        },
        getQuery: function(a) {
        ...
        getSuggestions: function(a) {
            ...
            h = e.ignoreParams ? null : e.params;
            c.isLocal ? b = c.getSuggestionsLocal(a) : (d.isFunction(f) && (f = f.call(c.element, a)), g = f + "?" + d.param(h || {}), b = c.cachedResponse[g]);
            b && d.isArray(b.suggestions) ? (c.suggestions = b.suggestions, c.suggest()) : c.isBadQuery(a) || !1 === e.onSearchStart.call(c.element, e.params) || (c.currentRequest && c.currentRequest.abort(), c.currentRequest = d.ajax({
                ...
                b = e.transformResult(b);
                c.processResponse(b, a, g);
                e.onSearchComplete.call(c.element, a, b.suggestions)
            }).fail(function(b, d, f) {
        ...
        suggest: function() {
            if (0 === this.suggestions.length) this.options.showNoSuggestionNotice ? this.noSuggestions() : this.hide();
            else {
                var a = this.options,
                    b = a.formatResult,
                    ...
                    h = d(this.suggestionsContainer),
                    g = d(this.noSuggestionsContainer),
                    k = a.beforeRender,
                    l = "",
                    m;
                if (a.triggerSelectOnValidInput && (m = this.findSuggestionIndex(c), -1 !== m)) {
                    this.select(m);
                    return
                }
                d.each(this.suggestions, function(a, d) {
                    l += '<div class="' + e + '" data-index="' + a + '">' + b(d, c) + "</div>"
                });
                this.adjustContainerWidth();
                g.detach();
                h.html(l);
                a.autoSelectFirst && (this.selectedIndex = 0, h.children().first().addClass(f));
                d.isFunction(k) && k.call(this.element, h);
                this.fixPosition();
                h.show();
                this.visible = !0;
                this.findBestHint()
        ...
        noSuggestions: function() {
            var a = d(this.suggestionsContainer),
                b = d(this.noSuggestionsContainer);
            this.adjustContainerWidth();
            b.detach();
            a.empty();
            a.append(b);
        ...
        adjustContainerWidth: function() {
            var a = this.options,
                b = d(this.suggestionsContainer);
            "auto" === a.width && (a = this.el.outerWidth() - 2, b.width(0 < a ? a : 300))
        },
        ...
        validateOrientation: function(a, b) {
            ...
            "-1" == ["auto", "bottom", "top"].indexOf(a) && (a = b);
            return a
        },
        processResponse: function(a, b, c) {
            var d = this.options;
            a.suggestions = this.verifySuggestionsFormat(a.suggestions);
            d.noCache || (this.cachedResponse[c] = a, d.preventBadQueries && 0 === a.suggestions.length && this.badQueries.push(b));
        ...
        onSelect: function(a) {
            ...
            this.currentValue !== this.el.val() && this.el.val(this.currentValue);
            this.signalHint(null);
            this.suggestions = [];
            this.selection = a;
    ...
    d.fn.autocomplete = function(a, b) {
        return 0 === arguments.length ? this.first().data("autocomplete") : this.each(function() {
            ...
            } else e && e.dispose && e.dispose(), e = new k(this, a), c.data("autocomplete", e)
        })
    }
});