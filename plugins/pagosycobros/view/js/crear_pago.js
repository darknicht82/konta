$(document).ready(function() {
   $("#f_nuevo_pago").submit(function (event) {
      $("#btn_save_pago").attr('disabled', true);
      ...
      $.ajax({
         ...
         success: function(data){
            ...
            if (datos.error == 'T') {
               alert(datos.msj);
               $("#btn_save_pago").attr('disabled', false);
            } else {
               alert(datos.msj);
...
function calcular_total() {
   ...
   let totalpagar = parseFloat($("#total_pagar").val());
   ...
   if (total > 0) {
      ...
      $("#btn_save_pago").prop('disabled', false);
      $("#fpselec").val('');
      $("#num_doc").val('');
      ...
      $("#btn_save_pago").prop('disabled', true);
   }
}
